  ...
  return (
    <div>
      <div className="text-center mb-8 relative z-10">
        <h2 className="text-7xl font-medium mb-4 bg-gradient-to-b from-white to-white/80 bg-clip-text text-transparent">
          Our clients
        </h2>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <div className="absolute inset-0 hidden md:block">
              {/* Horizontal Lines */}
              <div
                className="absolute top-1/3 -mt-5 w-full h-[1px]"
                style={{
                  background:
              ...
              />
              <div
                className="absolute top-2/3 mt-4 w-full h-[1px]"
                style={{
                  background:
                    "linear-gradient(90deg, transparent, rgba(255,255,255,0.3), transparent)",
                }}
            ...
            <div className="grid md:grid-cols-2 gap-2 items-center justify-center min-h-[calc(100vh/3)]">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <div
                    className="absolute left-2/4 h-full w-[1px]"
                    style={{
                      background:
                        "linear-gradient(180deg, transparent, rgba(255,255,255,0.3), transparent)",
                    }}
                  />
                  <div className="w-full max-h-[190px] flex justify-end mx-10 items-center">
                    <Image
                      src={
              ...
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  exit={{ opacity: 0, x: -20 }}
                  transition={{ duration: 0.5 }}
                  className="flex flex-col  text-justify justify-center items-center space-y-4"
                >
                  <blockquote
                    className="text-3xl text-justify font-medium"
                    style={{
                      background:
